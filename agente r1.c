...
int vLixoA[] = {5, 5, 5, 5, 5, 5};
int vLixoB[];

int indA = 0;/*indice do vetor lixo A*/
int indB = 0;
int bag[];
...
void voltarLixeiraX()
{
    ...
    if(posAgenteX<12)
    {
        if(ambiente[posAgenteX+1][posAgenteY] != LIXO1 && ambiente[posAgenteX+1][posAgenteY] != LIXO2){
            guardaPosicao = ambiente[posAgenteX+1][posAgenteY];
            ambiente[posAgenteX][posAgenteY] = guardaPosicao;
        }
    ...
    if(posAgenteY>1)
    {
        if(ambiente[posAgenteX][posAgenteY-1] != LIXO1 && ambiente[posAgenteX][posAgenteY-1] != LIXO2 ){
            guardaPosicao = ambiente[posAgenteX][posAgenteY-1];
            ambiente[posAgenteX][posAgenteY] = guardaPosicao;
        }
...
void voltarRecicladora(int mochila)
{
...
int main()
{
    ...
    testaEstrela = countStar;/*iniciando com os valores iniciais*/
    testaPonto = countPonto;
    ...
    while(!verificarSucesso())
    {
        ...
        {
            if(posAgenteY<=9){
                    //voltarLixeiraX(mochila);
                    if(testaEstrela > countStar){
                        vLixoA[indA] = 2;
                        testaEstrela = countStar;/*pra igualar os valores novamente*/
                        indA++;
                        voltarLixeiraX(mochila);
                    }else if(testaPonto > countPonto){
                        vLixoA[indA] = 1;
                        testaPonto = countPonto;/*pra igualar os valores novamente*/
                        indA++;
                        voltarLixeiraX(mochila);
                    }
            }
